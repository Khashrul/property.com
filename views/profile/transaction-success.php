<div id="wrapper">
    ...
    <section class="section-light section-top-shadow">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-9 col-md-push-3" style="background: rgba(6, 172, 9, 0.41);padding: 100px;border-radius: 5px;border:1px solid #414141;font-family: verdana" >
                    <?php if(isset($payment_details)){ ?>
                    <h3 align="center">Your transaction successful</h3>
                    <div class="form-group" style="text-align: center;margin-top: 20px">
                        <label style="color: #5d5d5d">Your Transaction Id:</label>
                        <span style="color: #5d5d5d"><?php echo $payment_details->order_id ?></span>
                        <p style="color: #5d5d5d">You can now <a href="<?php echo Yii::$app->urlManager->createUrl('/submit-property') ?>">add property</a></p>
                    </div>
                    <?php } else { ?>
                        <h3 align="center">You have been subscribed with Free Package</h3>
                        <div class="form-group" style="text-align: center;margin-top: 20px">
                            <p style="color: #5d5d5d">You can now <a href="<?php echo Yii::$app->urlManager->createUrl('/submit-property') ?>">add property</a></p>
                        </div>
                    <?php } ?>
